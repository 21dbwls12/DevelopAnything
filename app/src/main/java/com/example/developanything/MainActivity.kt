...
@Composable
fun ChangingButton(onclick: () -> Unit, text: String, currentNumber: Int, buttonNumber: Int) {
    Button(
...
fun onClickIntent(context: Context, activity: Class<out Activity>) {
...
@Composable
fun TopAppBar(title: String, iconButton: @Composable (() -> Unit)?) {
...
@Composable
fun BottomAppBar(currentNumber: Int) {
...
fun getIconForItem(item: String): ImageVector {
    return when (item) {
...
fun activityIndex(index: Int): Class<out Activity> {
    return when (index) {
